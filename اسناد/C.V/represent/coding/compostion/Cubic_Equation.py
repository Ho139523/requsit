...
# This script (Cubic Equation Solver) is an independent program for computation of roots of Cubic Polynomials. This
# script, however, has no relation with original project code or calculations. It is to be also made clear that no
# knowledge of it's original project is included or used to device this script. This script is complete freeware
# developed by above signed users, and may further be used or modified for commercial or non-commercial purpose.
